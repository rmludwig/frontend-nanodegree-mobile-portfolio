/* 
Rich Ludwig March 2015

View the README.txt in the frontend-nanodegree-mobile-portfolio directory

WARNING!!!

This file is being minified using gulp.js. The pizza.html is now pointed to
the dist/all.min.js file rather than this one directly. Make sure you are 
running gulp when making changes to this file. Run gulp from the main project
directory for the portfolio project. The gulp tools must be installed on your
system. For instructions see http://travismaynard.com/writing/getting-started-with-gulp
...
var pizzaElementGenerator = function(i) {
  ...
  pizzaContainer.style.height = "350px";
...
var resizePizzas = function(size) { 
  ...
  function determineDx (elem, size) {
    ...
    //rml logging for testing
    //console.log("determineDx called");

    return dx;
  }

  // Removed from loop below to save time.
  // Prepare new width shared by all pizza using the width of pizza0
...
// Moved this outside the loop to speed up initial page load
...
document.addEventListener('DOMContentLoaded', function() {
  var cols = 8;
  var s = 256;
  // Each row is 256 px high, 8 cols, Setting max window size to ~1532 px tall (6 row)
  // so max number of movers is 48 to speed this up
  for (var i = 0; i < 48; i++) {
